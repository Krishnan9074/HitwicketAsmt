...
const ChessGame = () => {
  ...
  const renderMoveButtons = () => {
    ...
    let moves;
    if (selectedCharacter.includes('H3')) {
      moves = ['FL', 'FR', 'BL', 'BR', 'RF', 'LF', 'RB', 'LB'];
    } else if (selectedCharacter.includes('H2')) {
      moves = ['FL', 'FR', 'BL', 'BR'];
    } else {
      moves = ['L', 'R', 'F', 'B'];
    }
    ...
    return moves.map((move) => (
      <button
        ...
        onClick={() => makeMove(selectedCharacter, move)}
      >
        {move}
      </button>
    ));
  ...
  return (
    <div className="main-container">
      ...
      <div className="game-container">
        ...
        <div id="controls">
          <h3>
            Selected: <span id="selected-character">{selectedCharacter}</span>
          </h3>
      ...
      <div id="chat" className="panel chat-panel">
        ...
        <div id="chat-input-container">
          ...
          <button id="chat-send" onClick={handleChatSend}>
            <div id="send-chat" className="send-chat">Send</div>
          </button>
        </div>
      </div>
